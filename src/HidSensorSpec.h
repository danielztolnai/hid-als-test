...
#define HID_USAGE_SENSOR_STATE_NOT_AVAILABLE_SEL_ENUM                                       0x03 // Enum
#define HID_USAGE_SENSOR_STATE_NO_DATA_SEL_ENUM                                             0x04 // Enum
#define HID_USAGE_SENSOR_STATE_INITIALIZING_SEL_ENUM                                        0x05 // Enum
#define HID_USAGE_SENSOR_STATE_ACCESS_DENIED_SEL_ENUM                                       0x06 // Enum
#define HID_USAGE_SENSOR_STATE_ERROR_SEL_ENUM                                               0x07 // Enum
...
//event enums
#define HID_USAGE_SENSOR_EVENT_UNKNOWN_SEL_ENUM                                             0x01 // Enum
#define HID_USAGE_SENSOR_EVENT_STATE_CHANGED_SEL_ENUM                                       0x02 // Enum
#define HID_USAGE_SENSOR_EVENT_PROPERTY_CHANGED_SEL_ENUM                                    0x03 // Enum
#define HID_USAGE_SENSOR_EVENT_DATA_UPDATED_SEL_ENUM                                        0x04 // Enum
#define HID_USAGE_SENSOR_EVENT_POLL_RESPONSE_SEL_ENUM                                       0x05 // Enum
#define HID_USAGE_SENSOR_EVENT_CHANGE_SENSITIVITY_SEL_ENUM                                  0x06 // Enum
